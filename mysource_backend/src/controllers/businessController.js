...
export const updateBusiness = async (req, res) => {
  ...
  try {
    ...
    const business = await prisma.business.findUnique({
      where: { id: businessId }, // Use parsed integer
    });
...
export const deleteBusiness = async (req, res) => {
  ...
  try {
    ...
    await prisma.image.deleteMany({
      where: { businessId: businessId }, // Use parsed integer
    });
        ...
        imagePromises.push(
          prisma.image.create({
            data: {
              url: imageData.url,
              thumbnailUrl: imageData.thumbnailUrl,
              businessId: businessId, // Use parsed integer
            },
          }),
        );
      }
...
export const deleteBusinessImage = async (req, res) => {
  ...
  try {
    ...
    await prisma.image.delete({
      where: { id: parsedImageId }, // Use parsed integer
    });
...
export const getBusinessesByIds = async (req, res) => {
  try {
    ...
    const businesses = await prisma.business.findMany({
      where: {
        id: {
          in: businessIds, // Use parsed integers
        },
        isDisabled: false,
      },
      include: {
