...
// Enhanced transaction creation with verification
...
// Accept a bid - FIXED ASSOCIATION ALIAS
  ...
  try {
    ...
    const bid = await Bid.findByPk(id, {
      include: [
        ...
        {
          model: User,
          as: "bidder", // FIXED: Use correct alias 'bidder' instead of 'freelancer'
          attributes: ["id", "name", "email"],
        },
      ],
    })
  ...
  try {
    ...
    const bid = await Bid.findByPk(id, {
      include: [
        ...
        {
          model: User,
          as: "bidder", // FIXED: Use correct alias 'bidder'
          attributes: ["id", "name", "email"],
        },
      ],
    })
