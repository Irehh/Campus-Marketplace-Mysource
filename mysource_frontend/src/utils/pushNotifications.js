...
// Add this function to skip the waiting phase after service worker installation
...
// Update the service worker message event handler to handle SKIP_WAITING message
if ("serviceWorker" in navigator) {
