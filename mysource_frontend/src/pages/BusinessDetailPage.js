...
// import { FiEdit2, FiTrash2, FiMessageSquare, FiMapPin, FiLink, FiPhone, FiClock, FiMessageCircle } from "react-icons/fi"
...
//           {(business.link || business.phone) && (
//             <div className="mt-2 space-y-1">
//               {business.link && (
//                 <a
//                   href={business.link.startsWith("http") ? business.link : `https://${business.link}`}
//                   target="_blank"
...
//               )}
//               {business.phone && (
//                 <a href={`tel:${business.phone}`} className="flex items-center text-xs text-primary hover:underline">
