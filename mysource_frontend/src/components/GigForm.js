  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500">Be specific about what you need, requirements, and expectations.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full px-3 py-2 border rounded-md ${errors.campus ? "border-red-500" : "border-gray-300"}`}
